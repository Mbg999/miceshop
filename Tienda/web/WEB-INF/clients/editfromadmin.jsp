...
<html>
    <head>
        ...
        <title>La Ratonería | <fmt:message key="editar"/> <fmt:message key="cliente"/></title>
                ...
                <main class="col-12 pt-4">
                    <div class="row">
                        ...
                        <div class="col-10 px-5 mx-auto">
                            <h2 class="mb-3"><fmt:message key="edicion del usuario con DNI"/>: ${(!empty DNI[0]) ? DNI[0] : uclient.DNI}</h2>
                            <form action="updatefromadmin" method="post">
                                <!-- DNI -->
                                <input type="text" value="${(!empty DNI[0]) ? DNI[0] : uclient.DNI}" class="form-control" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombre" id="nombre" class="form-control" placeholder="<fmt:message key="edicion del usuario con DNI"/>" value="${(nombre[0]) ? nombre[0] : uclient.nombre}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="fec_nac" id="fec_nac" class="form-control" value="${(fec_nac[0]) ? fec_nac[0] : uclient.fec_nac}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="direccion" id="direccion" class="form-control" placeholder="<fmt:message key="direccion"/>" value="${(direccion[0]) ? direccion[0] : uclient.direccion}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password" id="password" class="form-control" placeholder="<fmt:message key="password"/>" value="${(password[0]) ? password[0] : uclient.password}">
